...
```
https://quick-mern-setup.preview.emergentagent.com
```

### **API Documentation**
```
https://quick-mern-setup.preview.emergentagent.com/docs
```
...
**Application URL:** https://quick-mern-setup.preview.emergentagent.com
