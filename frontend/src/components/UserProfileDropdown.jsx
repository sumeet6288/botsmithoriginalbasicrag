...
import { MessageSquare, Settings, Users, LogOut, Bell, ChevronDown, Shield, CreditCard } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <DropdownMenuContent align="end" className="w-56 p-1.5 bg-white shadow-xl border-0 rounded-xl">
        ...
        >
          <div className="flex items-center gap-2 w-full">
            ...
            <span className="text-xs font-medium text-gray-700 group-hover:text-indigo-700 transition-colors">Subscription Details</span>
          </div>
        </DropdownMenuItem>
